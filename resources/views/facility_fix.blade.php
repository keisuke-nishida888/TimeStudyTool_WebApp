    ...
    <div class="container_facil">   
        <table  class="facil_table1">
                    ...
                    <tr>
                            ...
                            <td>
                            @if(isset($adddata[0]['item10']))
                                <input id="item10" type="text" maxlength="10" name="item10" value="{{\Illuminate\Support\Str::of($adddata[0]['item10'])->rtrim()}}">人
                            @else
                    ...
                    <tr>
                        ...
                        @if(isset($adddata[0]['item11']))
                            <input id="item11" type="text" maxlength="10" name="item11" value="{{\Illuminate\Support\Str::of($adddata[0]['item11'])->rtrim()}}">人
                        @else
                    ...
                    <tr>
                        ...
                        <td>
                            @if(isset($adddata[0]['item12']))
                                <input id="item12" type="text" maxlength="10" name="item12" value="{{\Illuminate\Support\Str::of($adddata[0]['item12'])->rtrim()}}">人
                            @else
                    ...
                    <tr>
                        ...
                        <td>
                            @if(isset($adddata[0]['item13']))
                                <input id="item13" type="text" maxlength="10" name="item13" value="{{\Illuminate\Support\Str::of($adddata[0]['item13'])->rtrim()}}">人
                            @else
                   ...
                   <table class="facil_table">
                        ...
                        <tr>
                            ...
                            <!-- 寝室 - 移乗介助対象者 -->
                                ...
                                @if(isset($adddata[0]['item14']))
                                    <input id="item14" type="text" maxlength="10" name="item14" value="{{\Illuminate\Support\Str::of($adddata[0]['item14'])->rtrim()}}">人
                                @else
                            ...
                            <!-- 寝室 - うち2人介助対象者 -->
                                ...
                                @if(isset($adddata[0]['item15']))
                                    <input id="item15" type="text" maxlength="10" name="item15" value="{{\Illuminate\Support\Str::of($adddata[0]['item15'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 寝室 - ※平均介助時間/分 -->
                                @if(isset($adddata[0]['item16']))
                                    <input id="item16" type="text" maxlength="10" name="item16" value="{{\Illuminate\Support\Str::of($adddata[0]['item16'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                            <!-- 寝室 - 一人あたり一日の平均移乗回数 -->
                                @if(isset($adddata[0]['item17']))
                                    <input id="item17" type="text" maxlength="10" name="item17" value="{{\Illuminate\Support\Str::of($adddata[0]['item17'])->rtrim()}}">回
                                @else
                        ...
                        <tr>
                            ...
                            <!-- 脱衣室 - 移乗介助対象者 -->
                                ...
                                @if(isset($adddata[0]['item18']))
                                    <input id="item18" type="text" maxlength="10" name="item18" value="{{\Illuminate\Support\Str::of($adddata[0]['item18'])->rtrim()}}">人
                                @else
                            ...
                            <!-- 脱衣室 - うち2人介助対象者 -->
                                ...
                                @if(isset($adddata[0]['item19']))
                                    <input id="item19" type="text" maxlength="10" name="item19" value="{{\Illuminate\Support\Str::of($adddata[0]['item19'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 脱衣室 - ※平均介助時間/分 -->
                                @if(isset($adddata[0]['item20']))
                                    <input id="item20" type="text" maxlength="10" name="item20" value="{{\Illuminate\Support\Str::of($adddata[0]['item20'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                            <!-- 脱衣室 - 一人あたり一日の平均移乗回数 -->
                                @if(isset($adddata[0]['item21']))
                                    <input id="item21" type="text" maxlength="10" name="item21" value="{{\Illuminate\Support\Str::of($adddata[0]['item21'])->rtrim()}}">回
                                @else
                        ...
                        <tr>
                            ...
                            <!-- 浴室 - 移乗介助対象者 -->
                                ...
                                @if(isset($adddata[0]['item22']))
                                    <input id="item22" type="text" maxlength="10" name="item22" value="{{\Illuminate\Support\Str::of($adddata[0]['item22'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 浴室 - うち2人介助対象者 -->
                                @if(isset($adddata[0]['item23']))
                                    <input id="item23" type="text" maxlength="10" name="item23" value="{{\Illuminate\Support\Str::of($adddata[0]['item23'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 浴室 - ※平均介助時間/分 -->
                                @if(isset($adddata[0]['item24']))
                                    <input id="item24" type="text" maxlength="10" name="item24" value="{{\Illuminate\Support\Str::of($adddata[0]['item24'])->rtrim()}}">分
                                @else
                            ...
                            <!-- 浴室 - 一人あたり一日の平均移乗回数 -->
                                ...
                                @if(isset($adddata[0]['item25']))
                                    <input id="item25" type="text" maxlength="10" name="item25" value="{{\Illuminate\Support\Str::of($adddata[0]['item25'])->rtrim()}}">回
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                            <!-- トイレ - 移乗介助対象者 -->
                                @if(isset($adddata[0]['item26']))
                                    <input id="item26" type="text" maxlength="10" name="item26" value="{{\Illuminate\Support\Str::of($adddata[0]['item26'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- トイレ - うち2人介助対象者 -->
                                @if(isset($adddata[0]['item27']))
                                    <input id="item27" type="text" maxlength="10" name="item27" value="{{\Illuminate\Support\Str::of($adddata[0]['item27'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- トイレ - ※平均介助時間/分 -->
                                @if(isset($adddata[0]['item28']))
                                    <input id="item28" type="text" maxlength="10" name="item28" value="{{\Illuminate\Support\Str::of($adddata[0]['item28'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                            <!-- トイレ - 一人あたり一日の平均移乗回数 -->
                                @if(isset($adddata[0]['item29']))
                                    <input id="item29" type="text" maxlength="10" name="item29" value="{{\Illuminate\Support\Str::of($adddata[0]['item29'])->rtrim()}}">回
                                @else
                    ...
                    <tr><td  colspan="5"><label class = "lb">{{ __('採用・教育コスト') }}</label></tr></td>
                        ...
                        <tr>
                            ...
                            <td>
                            <!-- 求人 - １ヵ月あたり求人サイト掲載費用 -->
                                @if(isset($adddata[0]['item30']))
                                    <input id="item30" type="text" maxlength="10" name="item30" value="{{\Illuminate\Support\Str::of($adddata[0]['item30'])->rtrim()}}">円
                                @else
                            ...
                            <td>
                            <!-- 求人 - 平均掲載期間 -->
                                @if(isset($adddata[0]['item31']))
                                    <input id="item31" type="text" maxlength="10" name="item31" value="{{\Illuminate\Support\Str::of($adddata[0]['item31'])->rtrim()}}">ヵ月
                                @else
                            ...
                            <td>
                            <!-- 求人 - １ヵ月あたり面接人数 -->
                                @if(isset($adddata[0]['item32']))
                                    <input id="item32" type="text" maxlength="10" name="item32" value="{{\Illuminate\Support\Str::of($adddata[0]['item32'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 求人 - 1人あたり平均面接時間 -->
                                @if(isset($adddata[0]['item33']))
                                    <input id="item33" type="text" maxlength="10" name="item33" value="{{\Illuminate\Support\Str::of($adddata[0]['item33'])->rtrim()}}">分
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                            <!-- 新人研修 - 年間入社人数 -->
                                @if(isset($adddata[0]['item34']))
                                    <input id="item34" type="text" maxlength="10" name="item34" value="{{\Illuminate\Support\Str::of($adddata[0]['item34'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 新人研修 - ※1人あたり研修担当職員数 -->
                                @if(isset($adddata[0]['item35']))
                                    <input id="item35" type="text" maxlength="10" name="item35" value="{{\Illuminate\Support\Str::of($adddata[0]['item35'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 新人研修 - １日あたり研修時間 -->
                                @if(isset($adddata[0]['item36']))
                                    <input id="item36" type="text" maxlength="10" name="item36" value="{{\Illuminate\Support\Str::of($adddata[0]['item36'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                            <!-- 新人研修 - 研修期間日数 -->
                                @if(isset($adddata[0]['item37']))
                                    <input id="item37" type="text" maxlength="10" name="item37" value="{{\Illuminate\Support\Str::of($adddata[0]['item37'])->rtrim()}}">日
                                @else
                        ...
                        <tr>
                            ...
                            <td>
                            <!-- 外部研修 - 研修回数/年 -->
                                @if(isset($adddata[0]['item38']))
                                    <input id="item38" type="text" maxlength="10" name="item38" value="{{\Illuminate\Support\Str::of($adddata[0]['item38'])->rtrim()}}">回
                                @else
                            ...
                            <td>
                            <!-- 外部研修 - 平均参加費/回 -->
                                @if(isset($adddata[0]['item39']))
                                    <input id="item39" type="text" maxlength="10" name="item39" value="{{\Illuminate\Support\Str::of($adddata[0]['item39'])->rtrim()}}">円
                                @else
                    ...
                    <tr><td  colspan="5"><label class = "lb">{{ __('アクシデントコスト') }}</label></td></tr>
                        ...
                        <tr>
                            <td>
                                <!-- 皮膚剥離 - 年間発生件数 -->
                                @if(isset($adddata[0]['item40']))
                                    <input id="item40" type="text" maxlength="10" name="item40" value="{{\Illuminate\Support\Str::of($adddata[0]['item40'])->rtrim()}}">件
                                @else
                                    <input id="item40" type="text" maxlength="10" name="item40" value="{{old('item40')}}">件
                                @endif
                                <span class="invalid-feedback validate" role="alert">
                            ...
                            <td>
                                <!-- 皮膚剥離 - 1件あたり処置時間 -->
                                @if(isset($adddata[0]['item41']))
                                    <input id="item41" type="text" maxlength="10" name="item41" value="{{\Illuminate\Support\Str::of($adddata[0]['item41'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                                <!-- 皮膚剥離 - 1件あたり報告書作成時間 -->
                                @if(isset($adddata[0]['item42']))
                                    <input id="item42" type="text" maxlength="10" name="item42" value="{{\Illuminate\Support\Str::of($adddata[0]['item42'])->rtrim()}}">分
                                @else
                        ...
                        <tr>
                            <td>
                                <!-- 褥瘡 - 年間発生件数 -->
                                    @if(isset($adddata[0]['item43']))
                                        <input id="item43" type="text" maxlength="10" name="item43" value="{{\Illuminate\Support\Str::of($adddata[0]['item43'])->rtrim()}}">件
                                    @else
                            ...
                            <td>
                                <!-- 褥瘡 - 1件あたり処置時間 -->
                                @if(isset($adddata[0]['item44']))
                                    <input id="item44" type="text" maxlength="10" name="item44" value="{{\Illuminate\Support\Str::of($adddata[0]['item44'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                            <!-- 褥瘡 - 1件あたり報告書作成時間 -->
                                @if(isset($adddata[0]['item45']))
                                    <input id="item45" type="text" maxlength="10" name="item45" value="{{\Illuminate\Support\Str::of($adddata[0]['item45'])->rtrim()}}">分
                                @else
                        ...
                        <tr>
                            <td>
                            <!-- 骨折 - 年間発生件数 -->
                                @if(isset($adddata[0]['item46']))
                                    <input id="item46" type="text" maxlength="10" name="item46" value="{{\Illuminate\Support\Str::of($adddata[0]['item46'])->rtrim()}}">件
                                @else
                            ...
                            <td>
                            <!-- 骨折 - 1件あたり報告書作成時間 -->
                                @if(isset($adddata[0]['item47']))
                                    <input id="item47" type="text" maxlength="10" name="item47" value="{{\Illuminate\Support\Str::of($adddata[0]['item47'])->rtrim()}}">分
                                @else
                        ...
                        <tr>
                            <td>
                                <!-- ※通院 - 年間発生件数 -->
                                @if(isset($adddata[0]['item48']))
                                    <input id="item48" type="text" maxlength="10" name="item48" value="{{\Illuminate\Support\Str::of($adddata[0]['item48'])->rtrim()}}">件
                                @else
                            ...
                            <td>
                                <!-- ※通院 - 1件あたり通院介助時間 -->
                                @if(isset($adddata[0]['item49']))
                                    <input id="item49" type="text" maxlength="10" name="item49" value="{{\Illuminate\Support\Str::of($adddata[0]['item49'])->rtrim()}}">分
                                @else
                        ...
                        <tr>
                            <td>
                                <!-- ※入院 - 年間発生件数 -->
                                @if(isset($adddata[0]['item51']))
                                    <input id="item51" type="text" maxlength="10" name="item51" value="{{\Illuminate\Support\Str::of($adddata[0]['item51'])->rtrim()}}">件
                                @else
                            ...
                            <td>
                                <!-- ※入院 - １件あたり平均入院期間 -->
                                @if(isset($adddata[0]['item52']))
                                    <input id="item52" type="text" maxlength="10" name="item52" value="{{\Illuminate\Support\Str::of($adddata[0]['item52'])->rtrim()}}">日
                                @else
                    ...
                    <tr><td colspan="5"><label class = "lb">{{ __('その他ケアに関するコスト') }}</label></td></tr>
                        ...
                        <td>
                            <!-- オムツコスト（パッド含む） - オムツ使用者 -->
                                @if(isset($adddata[0]['item53']))
                                    <input id="item53" type="text" maxlength="10" name="item53" value="{{\Illuminate\Support\Str::of($adddata[0]['item53'])->rtrim()}}">人
                                @else
                            ...
                            <!-- オムツコスト（パッド含む） - 1日あたり総使用枚数 -->
                                @if(isset($adddata[0]['item54']))
                                    <input id="item54" type="text" maxlength="10" name="item54" value="{{\Illuminate\Support\Str::of($adddata[0]['item54'])->rtrim()}}">枚
                                @else
                            ...
                            <!-- オムツコスト（パッド含む） - 1枚あたりオムツ単価 -->
                                @if(isset($adddata[0]['item55']))
                                    <input id="item55" type="text" maxlength="10" name="item55" value="{{\Illuminate\Support\Str::of($adddata[0]['item55'])->rtrim()}}">円
                                @else
                        ...
                        <td>
                            <!-- 排泄介助コスト - 要一部介助 -->
                                @if(isset($adddata[0]['item56']))
                                    <input id="item56" type="text" maxlength="10" name="item56" value="{{\Illuminate\Support\Str::of($adddata[0]['item56'])->rtrim()}}">人
                                @else
                            ...
                            <!-- 排泄介助コスト - うち二人介助を要する対象者数 -->
                                @if(isset($adddata[0]['item57']))
                                    <input id="item57" type="text" maxlength="10" name="item57" value="{{\Illuminate\Support\Str::of($adddata[0]['item57'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 排泄介助コスト - 一人あたり介助所要時間 -->
                                @if(isset($adddata[0]['item58']))
                                    <input id="item58" type="text" maxlength="10" name="item58" value="{{\Illuminate\Support\Str::of($adddata[0]['item58'])->rtrim()}}">分
                                @else
                        ...
                        <td>
                            ...
                            <td>
                            <!-- 排泄介助コスト - うち二人介助を要する対象者数 -->
                                @if(isset($adddata[0]['item70']))
                                    <input id="item70" type="text" maxlength="10" name="item70" value="{{\Illuminate\Support\Str::of($adddata[0]['item70'])->rtrim()}}">人
                                @else
                            ...
                            <td>
                            <!-- 排泄介助コスト - 一人あたり介助所要時間 -->
                                @if(isset($adddata[0]['item71']))
                                    <input id="item71" type="text" maxlength="10" name="item71" value="{{\Illuminate\Support\Str::of($adddata[0]['item71'])->rtrim()}}">分
                                @else
                        ...
                        <td>
                            ...
                            <td>
                            <!-- 食事介助コスト - 1人あたり介助所要時間 -->
                                @if(isset($adddata[0]['item62']))
                                    <input id="item62" type="text" maxlength="10" name="item62" value="{{\Illuminate\Support\Str::of($adddata[0]['item62'])->rtrim()}}">分
                                @else
                            ...
                            <td>
                            <!-- 食事介助コスト - 一日辺りの食事介助回数 -->
                                @if(isset($adddata[0]['item63']))
                                    <input id="item63" type="text" maxlength="10" name="item63" value="{{\Illuminate\Support\Str::of($adddata[0]['item63'])->rtrim()}}">回
                                @else
                        ...
                        <tr class="cs_hidden">
                            <td>
                                <!-- 座位修正介助コスト - 対象者 -->
                                    @if(isset($adddata[0]['item64']))
                                        <input id="item64" type="text" maxlength="10" name="item64" value="{{\Illuminate\Support\Str::of($adddata[0]['item64'])->rtrim()}}">人
                                    @else
                                ...
                                <!-- 座位修正介助コスト - 1人あたり介助所要時間 -->
                                    @if(isset($adddata[0]['item66']))
                                        <input id="item66" type="text" maxlength="10" name="item66" value="{{\Illuminate\Support\Str::of($adddata[0]['item66'])->rtrim()}}">分
                                    @else
                                        <input id="item66" type="text" maxlength="10" name="item66" value="{{old('item66')}}">分
                                    @endif
                                ...
                                <!-- 座位修正介助コスト - 1日あたり総介助回数 -->
                                    @if(isset($adddata[0]['item67']))
                                        <input id="item67" type="text" maxlength="10" name="item67" value="{{\Illuminate\Support\Str::of($adddata[0]['item67'])->rtrim()}}">回
                                    @else
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- 腰痛保持率 -->
                            @if(isset($adddata[0]['item68']))
                                <input id="item68" type="text" maxlength="10" name="item68" value="{{\Illuminate\Support\Str::of($adddata[0]['item68'])->rtrim()}}">%
                            @else
